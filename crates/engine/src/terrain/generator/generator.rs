...
impl TerrainGenerator {
    ...
    pub fn generate(&self, chunk_coord: ChunkCoords) -> ChunkData {
        ...
        let mut voxels = vec![Voxel::AIR; CHUNK_WIDTH * CHUNK_DEPTH * CHUNK_HEIGHT];

        for lx in 0..CHUNK_WIDTH {
            let world_x = (chunk_coord.x * CHUNK_WIDTH as i32 + lx as i32) as f32;
            ...
            for lz in 0..CHUNK_DEPTH {
                ...
                let fill_to = (height as usize).min(CHUNK_HEIGHT);

                for ly in 0..fill_to {
                    voxels[index(lx, ly, lz)] = Voxel::SOLID;
                }
            }
        }
